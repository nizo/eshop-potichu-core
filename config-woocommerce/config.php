...
function avia_woocommerce_before_main_content()
{
	...
	echo "<div class='container_wrap container_wrap_first main_color ".avia_layout_class( 'main' , false )." template-shop shop_columns_".apply_filters( 'loop_shop_columns', 4 )."'>";
...
add_action( 'woocommerce_before_shop_loop', 'woocommerce_taxonomy_archive_description_with_image', 11 );
...
if(!function_exists('avia_woocommerce_frontend_search_params'))
{
	...
	function avia_woocommerce_frontend_search_params()
	{
		...
		$product_order['unit-price'] = __("Jednotkovej ceny",'avia_framework');
		...
		$po_key = !empty($avia_config['woocommerce']['product_order']) ? $avia_config['woocommerce']['product_order'] : 'unit-price';
	...
	function avia_woocommerce_overwrite_catalog_ordering($args)
	{
		...
		if(!empty($product_order))
		{
			switch ( $product_order ) {
				...
				case 'unit-price' : $orderby = 'meta_value_num'; $order = 'asc'; $meta_key = 'jednotkovacena'; break;
				//default : $orderby = 'meta_value_num'; $order = 'asc'; $meta_key = 'jednotkovacena'; break;
				default : $orderby = 'menu_order'; $order = 'desc'; $meta_key = '';  break;
