...
$avia_elements[] = array(
		"name" 	=> __("Display social icons below main menu? (You can set your social icons at <a href='#goto_social_profiles'>Social Profiles</a>)", 'avia_framework'),
...
$avia_elements[] =	array(
					...
					"desc" 	=> __("Here you can choose the width of your content and sidebar. First Number indicates the content width, second number indicates sidebar width. <br/><strong>Note:</strong> If you want to disable sidebars you can do so in the <a href='#goto_sidebar_settings'>Sidebar Settings</a>", 'avia_framework'),
					"id" 	=> "content_width",
...
$avia_elements[] =	array(
					...
					"desc" 	=> __("We have detected that you are using a Child Theme. That's Great!. If you want to, we can import the settings of your Parent theme to your Child theme. <br/>Please be aware that this will overwrite your current child theme settings.", 'avia_framework'),
...
$avia_elements[] =	array(
	...
	"desc" 		=> __("You can upload additional Iconfont Packages generated with <a href='http://fontello.com/' target='_blank'>Fontello</a> to use them in your Layout Builder.<br/><br/>The 'Default Font' can't be deleted. <br/><br/>Make sure to delete any fonts that you are not using, to keep the loading time for your visitors low", 'avia_framework'),
	"id" 		=> "iconfont_upload",
...
$avia_elements[] =	array(
					...
					"desc" 	=> __("Upload a logo image, or enter the URL or ID of an image if its already uploaded. The themes default logo gets applied if the input field is left blank<br/>Logo Dimension: 340px * 156px (if your logo is larger you might need to modify style.css to align it perfectly)", 'avia_framework'),
					"id" 	=> "logo",
					"type" 	=> "upload",
...
$avia_elements[] =	array(
					...
					"desc" 	=> __("Specify a <a href='http://en.wikipedia.org/wiki/Favicon'>favicon</a> for your site. <br/>Accepted formats: .ico, .png, .gif", 'avia_framework'),
					"id" 	=> "favicon",
					"type" 	=> "upload",
...
$avia_elements[] =	array(
					...
					"desc" 		=> __("If a value is left empty or set to default then it will not be changed from the value defined in your CSS files", 'avia_framework')."<br/><br/>".
									__("<strong>Attention:</strong> This feature is in active <strong>BETA!</strong> We will constantly add new elements to customize and need your help: If you got any suggestions on what to add please <a target='_blank' href='http://www.kriesi.at/support/enfold-feature-requests/'>post them here</a>"."<br/><br/>", 'avia_framework'),
					"id" 		=> "advanced_styling",
					"type" 		=> "styling_wizard",
...
foreach($colorsets as $set_key => $set_value)
{
	...
	$avia_elements[] =	array(
					...
					"desc" 	=> __("Secondary color for link and button hover, etc<br/>", 'avia_framework'),
	...
	$avia_elements[] = array(
						...
						"desc" 	=> __("The background image of your $set_value<br/><br/>", 'avia_framework'),
						"type" 	=> "select",
	...
	$avia_elements[] =	array(
						...
						"desc" 	=> __("Upload a BG image for your $set_value<br/><br/>", 'avia_framework'),
...
$avia_elements[] =	array(
					...
					"desc" 	=> __("Background color for your site<br/> This is the color that is displayed behind your boxed content area", 'avia_framework'),
					"id" 	=> "color-body_color",
					"type" 	=> "colorpicker",
					"std" 	=> "#eeeeee",
/* 					"class" => "av_2columns av_col_2", */
	...
	$avia_elements[] =	array(
						"slug"	=> "styling",
						"name" 	=> __("Custom Background Image", 'avia_framework'),
						"desc" 	=> __("Upload a BG image for your Body<br/><br/>", 'avia_framework'),
...
$avia_elements[] =	array(	"name" 	=> __("Defines the Font for your body text", 'avia_framework'),
							"slug"	=> "styling",
							"desc" 	=> __("Choose between web safe fonts (faster rendering) and google webkit fonts (more unqiue)<br/><br/>", 'avia_framework'),
				            "id" 	=> "default_font",
				            "type" 	=> "select",
				            "no_first" => true,
				            "class" => "av_2columns av_col_2",
...
$avia_elements[] =	array(
					...
					"desc" 	=> __("Chose if and where to display social icons. You can define the icons at <a href='#goto_social_profiles'>Social Profiles</a>", 'avia_framework'),
					"id" 	=> "header_social",
					"type" 	=> "select",
					"std" 	=> "",
					"class" => "av_2columns av_col_1",
...
$avia_elements[] =	array(	"name" => __("Your social profiles", 'avia_framework'),
							"desc" => __("You can enter links to your social profiles here. Afterwards you can choose were to display them by activating them in the respective area (e.g: <a href='#goto_general_layout'>General Layout</a>, <a href='#goto_header'>Header</a>, <a href='#goto_footer'>Footer</a> )", 'avia_framework'),
...
$avia_elements[] =	array(
					...
					"desc" 	=> __("How many colmns should be diplayed in your footer", 'avia_framework'),
					"id" 	=> "footer_columns",
					"type" 	=> "select",
					"std" 	=> "4",
					"subtype" => array(
...
$avia_elements[] = array(
		...
		"desc" 	=> __("Check to display the social icons defined in <a href='#goto_social_profiles'>Social Profiles</a> in your socket", 'avia_framework'),
		"id" 	=> "footer_social",
		"type" 	=> "checkbox",
		"std"	=> "",
		"slug"	=> "footer");	
...
$avia_elements[] =	array(	"name" => __("Import demo files", 'avia_framework'),
							"desc" => __("If you are new to wordpress or have problems creating posts or pages that look like the <a href='http://www.kriesi.at/themes/enfold/'>Theme Demo</a> you can import dummy posts and pages here that will definitely help to understand how those tasks are done.", 'avia_framework'),
							"id" => "widgetdescription",
							"std" => "",
							"slug"	=> "demo",
							"type" => "heading",
...
$avia_elements[] =	array(
					...
					"desc" 	=> 	 "<p><strong>".__("What you get: <a href='http://www.kriesi.at/themes/enfold' target='_blank'>Online Demo</a>", 'avia_framework')."</strong></p>"
...
$avia_elements[] =	array(
					...
					"desc" 	=> 	 "<p><strong>".__("What you get: <a href='http://www.kriesi.at/themes/enfold-business-flat' target='_blank'>Online Demo</a>", 'avia_framework')."</strong></p>"
								."<h4 class='av-before-plugins'>".__("Recommended Plugins:", 'avia_framework')."</h4><ul>"
...
$avia_elements[] =	array(
					...
					"desc" 	=> 	 "<p><strong>".__("What you get: <a href='http://www.kriesi.at/themes/enfold-photography' target='_blank'>Online Demo</a>", 'avia_framework')."</strong></p>"
								."<h4 class='av-before-plugins'>".__("Recommended Plugins:", 'avia_framework')."</h4><ul>"
...
$avia_elements[] =	array(
					...
					"desc" 	=> 	 "<p><strong>".__("What you get: <a href='http://www.kriesi.at/themes/enfold-restaurant' target='_blank'>Online Demo</a>", 'avia_framework')."</strong></p>"
								."<h4 class='av-before-plugins'>".__("Recommended Plugins:", 'avia_framework')."</h4><ul>"
...
$avia_elements[] =	array(
					...
					"desc" 	=> 	 "<p><strong>".__("What you get: <a href='http://www.kriesi.at/themes/enfold-restaurant-one-page' target='_blank'>Online Demo</a>", 'avia_framework')."</strong></p>"
								."<h4 class='av-before-plugins'>".__("Recommended Plugins:", 'avia_framework')."</h4><ul>"
								."<li>".__("<a href='http://wordpress.org/plugins/woocommerce/' target='_blank'>WooCommerce</a> (if you want to provide online ordering and delivery)", 'avia_framework')."</li>"
								."</ul>"
								."<h4 class='av-before-plugins'>".__("Demo Images included:", 'avia_framework')."</h4><ul>"
...
$avia_elements[] =	array(
					...
					"desc" 	=> 	 "<p><strong>".__("What you get: <a href='http://www.kriesi.at/themes/enfold-blog' target='_blank'>Online Demo</a>", 'avia_framework')."</strong></p>"
								."<h4 class='av-before-plugins'>".__("Recommended Plugins:", 'avia_framework')."</h4><ul>"
								."<li>".__("None", 'avia_framework')."</li>"
								."</ul>"
								."<h4 class='av-before-plugins'>".__("Demo Images included:", 'avia_framework')."</h4><ul>"
...
$avia_elements[] =	array(
					...
					"desc" 	=> 	 "<p><strong>".__("What you get: <a href='http://www.kriesi.at/themes/enfold-coming-soon' target='_blank'>Online Demo</a>", 'avia_framework')."</strong></p>"
								."<h4 class='av-before-plugins'>".__("Recommended Plugins:", 'avia_framework')."</h4><ul>"
								."<li>".__("None", 'avia_framework')."</li>"
								."</ul>"
								."<h4 class='av-before-plugins'>".__("Demo Images included:", 'avia_framework')."</h4><ul>"
