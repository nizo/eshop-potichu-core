...
?>
		<div id='header_meta' class='container_wrap container_wrap_meta <?php echo avia_header_class_string(array('header_social', 'header_secondary_menu', 'header_phone_active'), 'av_'); ?>'>
			      ...
			      <?php
					...
					<span class="flags-container-header"> 
					...
					switch ($webLocale) {
						...
						case 'cs':
							...
							<a href="#" class="active"><div class="shift">CZ</div><div class="cz"></div></a>';
							break;
						break;
					}
					?>
						...
						<!--
						<a href="http://eshop.potichu.sk/"><div class="shift">SK</div><div class="sk"></div></a>						
						<a href="#http://localhost/edsa-potichu-eshop/" class="active"><div class="shift">CZ</div><div class="cz"></div></a>
						-->
					</span>
			      </div>
		</div>
					...
					<div class='inner-container'>
						...
						*/
						...
						if( !empty($headerS['header_transparency']) && !empty($headerS['header_replacement_logo']) )
						{
							...
							echo avia_logo(AVIA_BASE_URL.'images/potichu-eshop-logo-sk.svg', $addition, 'strong', true);
						...
						*/
							...
							if ( is_user_logged_in() )
								...
								$menu_slug ='main-menu-neprihlaseny';
						    ...
						    echo "<nav class='main_menu' data-selectname='".__('Select a page','avia_framework')."' ".avia_markup_helper(array('context' => 'nav', 'echo' => false)).">";
						        ...
						        $args = array(
						            'theme_location'	=> $avia_theme_location,
						            'menu_id' 			=> 'main-menu-neprihlaseny',
