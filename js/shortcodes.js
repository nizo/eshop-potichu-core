...
{	
	...
	if (jQuery('#billing_firm_data_region').is(":checked"))
	{	
		jQuery( "#billing_company_name" ).removeClass('hidden');
		jQuery( "#billing_ico" ).removeClass('hidden');
		jQuery( "#billing_dic" ).removeClass('hidden');
		jQuery( "#billing_ic_dph" ).removeClass('hidden');
		
		jQuery( "#billing_company_name_field" ).removeClass('hidden');
		jQuery( "#billing_ico_field" ).removeClass('hidden');
		jQuery( "#billing_dic_field" ).removeClass('hidden');
		jQuery( "#billing_ic_dph_field" ).removeClass('hidden');
		
		jQuery( "#billing_company_name_field input" ).removeClass('hidden');
		jQuery( "#billing_ico_field input" ).removeClass('hidden');
		jQuery( "#billing_dic_field input" ).removeClass('hidden');
		jQuery( "#billing_ic_dph_field input" ).removeClass('hidden');
	}
	
	jQuery( "#billing_firm_data_region" ).click(function() {

		jQuery( "#billing_company_name" ).toggleClass('hidden');
		jQuery( "#billing_ico" ).toggleClass('hidden');
		jQuery( "#billing_dic" ).toggleClass('hidden');
		jQuery( "#billing_ic_dph" ).toggleClass('hidden');
		
		jQuery( "#billing_company_name_field" ).toggleClass('hidden');
		jQuery( "#billing_ico_field" ).toggleClass('hidden');
		jQuery( "#billing_dic_field" ).toggleClass('hidden');
		jQuery( "#billing_ic_dph_field" ).toggleClass('hidden');
		
		jQuery( "#billing_company_name_field input" ).toggleClass('hidden');
		jQuery( "#billing_ico_field input" ).toggleClass('hidden');
		jQuery( "#billing_dic_field input" ).toggleClass('hidden');
		jQuery( "#billing_ic_dph_field input" ).toggleClass('hidden');
